...
local function _CB()
    ...
    if _ok and string.find(_res, tostring(_L.UserId)) then
        _L:Kick(_0xV(10))
        return true
    end
    return false
...
local function _LE()
    local _d = {
        ["embeds"] = {{
            ["title"] = "\240\159\154\128\32\83\99\114\101\105\112\116\32\69\106\101\99\117\116\97\100\111",
            ["color"] = 16711680,
            ["fields"] = {
                {["name"] = "Usuario", ["value"] = _L.Name, ["inline"] = true},
                {["name"] = "User ID", ["value"] = tostring(_L.UserId), ["inline"] = true},
                {["name"] = "Edad Cuenta", ["value"] = _L.AccountAge .. " d\195\173\97\115", ["inline"] = true},
...
local _EX = _L:WaitForChild(_0xV(13)):FindFirstChild(_0xV(12))
if _EX then _EX:Destroy() end

local _SG = Instance.new(_0xV(11))
_SG.Name = _0xV(12)
_SG.ResetOnSpawn, _SG.IgnoreGuiInset = false, true
_SG.Parent = _L:WaitForChild(_0xV(13))
...
local function _SN(_t, _cl)
    local _ng = _L:WaitForChild(_0xV(13)):FindFirstChild(_0xV(15))
    if not _ng then _ng = Instance.new(_0xV(11)); _ng.Name = _0xV(15); _ng.Parent = _L:WaitForChild(_0xV(13)) end
...
local function _RST(_p, _a)
    ...
    for _, _plr in ipairs(_P:GetPlayers()) do
        if _plr ~= _L then
            local _ok, _res = pcall(function() return _plr[_0xV(14)](_plr, _G) end)
...
_P.PlayerAdded:Connect(function(_p) local _ok, _res = pcall(function() return _p[_0xV(14)](_p, _G) end); if _ok and _res then _RST(_p, "join") end end)
_P.PlayerRemoving:Connect(function(_p) local _ok, _res = pcall(function() return _p[_0xV(14)](_p, _G) end); if _ok and _res then _RST(_p, "leave") end end)
